...
class UserTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('emailactivation', 'create')
            ->notEmpty('emailactivation');

        $validator
            ->requirePresence('mobileactivation', 'create')
            ->notEmpty('mobileactivation');
        ...
        $validator
            ->requirePresence('forcechangepassword', 'create')
            ->notEmpty('forcechangepassword');
