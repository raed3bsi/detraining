...
<form id="qansform" method="post" target="/question/questionanswer/<?= $question->questionid ?>"
      >
    <div style="width: 100%;">
    <ul style="width: fit-content; list-style-type: none; max-width: 60%;float: left; padding-right: 5%;">
<?php foreach ($question->subquestions as $subqs):?>
        <li class=" ui-state-default">
            <div class="msqdrop">
    <?= $subqs->questiondescription ?>
        <?=
...
<?php endforeach; ?>
    ...
    <ul id="allopsdrop" style="width: fit-content; list-style-type: none; max-width: 30%;float: left;
        padding-left: 5%;">
...
<a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm('qansform')" style="width:80px">Submit</a>
    </div>
</form>
